...
contract CalsbergCoin is Context, IERC20, Ownable {
    ...
    string private _name = "CalsbergCoin";
    string private _symbol = "Berg";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 10; // 0.1 %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; // 0.1%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 10; // 0.1%
    uint256 private _previousmarketingFee = _marketingFee;
    address public marketingWallet = 0x0c460A9cC3b585A53f494F2DB933Bd260ae3E9f5;
    
    uint256 public _charityFee = 10; // 0.1%
    uint256 private _previouscharityFee = _charityFee;
    address public charityWallet = 0xe68b9E3f175B93c3591C97d611fd6790516eA672;
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tMarketing = tAmount.div(10000).mul(_marketingFee);
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tCharity = tAmount.div(10000).mul(_charityFee);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 marketingFee) external onlyOwner() {
        _taxFee = taxFee;
